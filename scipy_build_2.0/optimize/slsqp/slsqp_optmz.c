/* slsqp_optmz.f -- translated by f2c (version 20190311).
	...
	mode)
{
    ...
    static doublereal t;
    extern /* Subroutine */ int h12__(integer *, integer *, integer *, integer
...
/* Computing MIN */
	...
	i__2 = i__ + 1;
	i__3 = *mc - i__;
	h12__(&c__1, &i__, &i__2, n, &c__[i__ + c_dim1], lc, &w[iw + i__], &
		c__[j + c_dim1], lc, &c__1, &i__3);
	i__2 = i__ + 1;
	h12__(&c__2, &i__, &i__2, n, &c__[i__ + c_dim1], lc, &w[iw + i__], &e[
		e_offset], le, &c__1, me);
/* L10: */
	i__2 = i__ + 1;
	h12__(&c__2, &i__, &i__2, n, &c__[i__ + c_dim1], lc, &w[iw + i__], &g[
		g_offset], lg, &c__1, mg);
    }
...
/* L65: */
	i__2 = i__ + 1;
	h12__(&c__2, &i__, &i__2, n, &c__[i__ + c_dim1], lc, &w[iw + i__], &x[
		1], &c__1, &c__1, &c__1);
    }
    for (i__ = *mc; i__ >= 1; --i__) {
/* Computing MIN */
...
/* Computing MIN */
	...
	i__2 = i__ + 1;
	i__3 = *n - i__;
	h12__(&c__1, &i__, &i__2, me, &e[i__ * e_dim1 + 1], &c__1, &t, &e[j *
		e_dim1 + 1], &c__1, le, &i__3);
/* L10: */
	i__2 = i__ + 1;
	h12__(&c__2, &i__, &i__2, me, &e[i__ * e_dim1 + 1], &c__1, &t, &f[1], &
		c__1, &c__1, &c__1);
    }
	...
	integer *index, integer *mode)
{
    ...
    extern /* Subroutine */ int nnls__(doublereal *, integer *, integer *,
	    integer *, doublereal *, doublereal *, doublereal *, doublereal *,
...
/* L30: */
    ...
    iwdual = iy + *m;
/*  SOLVE DUAL PROBLEM */
    nnls__(&w[1], &n1, &n1, m, &w[if__], &w[iy], &rnorm, &w[iwdual], &w[iz], &
	    index[1], mode);
    if (*mode != 1) {
	goto L50;
    }
...
/* Subroutine */ int nnls__(doublereal *a, integer *mda, integer *m, integer *
...
/* STEP FOUR (TEST INDEX J FOR LINEAR DEPENDENCY) */
    ...
    i__2 = npp1 + 1;
    h12__(&c__1, &npp1, &i__2, m, &a[j * a_dim1 + 1], &c__1, &up, &z__[1], &
	    c__1, &c__1, &c__0);
    ...
    i__2 = npp1 + 1;
    h12__(&c__2, &npp1, &i__2, m, &a[j * a_dim1 + 1], &c__1, &up, &z__[1], &
	    c__1, &c__1, &c__1);
...
L160:
	...
	jj = index[jz];
/* L170: */
	h12__(&c__2, &nsetp, &npp1, m, &a[j * a_dim1 + 1], &c__1, &up, &a[jj *
...
/* Computing MIN */
	...
	i__2 = j + 1;
	i__3 = *n - j;
	h12__(&c__1, &j, &i__2, m, &a[j * a_dim1 + 1], &c__1, &h__[j], &a[i__ *
		 a_dim1 + 1], &c__1, mda, &i__3);
/* L80: */
	i__2 = j + 1;
	h12__(&c__2, &j, &i__2, m, &a[j * a_dim1 + 1], &c__1, &h__[j], &b[
...
/* L170: */
	i__2 = i__ - 1;
	h12__(&c__1, &i__, &kp1, n, &a[i__ + a_dim1], mda, &g[i__], &a[
...
/* L220: */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
/* L230: */
	    h12__(&c__2, &i__, &kp1, n, &a[i__ + a_dim1], mda, &g[i__], &b[jb *
...
/* Subroutine */ int h12__(integer *mode, integer *lpivot, integer *l1,
